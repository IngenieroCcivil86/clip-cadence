    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-primary/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <Card className="shadow-xl border-0 bg-card/50 backdrop-blur-sm">
          ...
          <CardContent>
            <Button
              ...
              className="w-full h-12 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 font-medium shadow-lg flex items-center justify-center space-x-3"
              disabled={isLoading}
            >
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p>Haz clic en "Continuar con Google" para acceder a la aplicación</p>
        </div>
      </div>
    </div>
  );
